                    ...
                    <table id="datatablesSimple">
                        <thead>
                            <tr>
                                ...
                                <th>Date</th>
                                <th>Action</th>
                                <th> Add News<span data-toggle="tooltip" data-placement="bottom" title="Add">
                        ...
                        <tbody>
                           @foreach ($news as $n )
                            <tr>
                                ...
                                <td>{{$n->author}}</td>
                                <td>
                                    <img src="{{$n->getFirstMediaUrl('image')}}" class="card-img-top " alt="..." width="60px" height="60px"></td>
                                <td>{{$n->created_at}}</td>    
                               
                                    <td>
                                        <a href="{{route('admin.news.newsedit',['id' => $n->id])}}" style="color: white">
                              <span  data-toggle="tooltip" data-placement="bottom" title="Edit">
                                ...
                                {{-- <span data-toggle="tooltip" data-placement="bottom" title="Add">
                                 ...
                                 <a href="{{route('admin.news.delete',['id' => $n->id])}}">
